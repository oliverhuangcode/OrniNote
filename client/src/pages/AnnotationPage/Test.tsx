import { createClient, User } from "@liveblocks/client";
...
let PUBLIC_KEY = "pk_dev_eH0jmBFlrKAt3C8vX8ZZF53cmXb5W6XoCyGx2A9NGCZV3-v2P-gqUav-vAvszF1x";
...
function updateCursor(user: User<Liveblocks["Presence"]>) {
...
function getCursorOrCreate(connectionId: number): HTMLElement {
...
function deleteCursor(user: User<Liveblocks["Presence"]>) {
